...
sql = '''CREATE TABLE AI_Feature (
    TokenId char(50) NOT NULL PRIMARY KEY,
    PairId char(50) NOT NULL,
    mint_count INT,
    swap_count INT,
    burn_count INT,
    mint_mean_period double,
    swap_mean_period double,
    burn_mean_period double,
    swap_in INT,
    swap_out int,
    LP_creator_holding_ratio double,
    Lock_rate double,
    Creator_token_holding_ratio,
